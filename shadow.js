 ...
 if (message.content === "f!help") {
  const embed = new Discord.RichEmbed() 
      ...
      .setDescription(`
        ...
        ***__General orders__***
**
:globe_with_meridians:  『id / معلومات عن حسابك』
:globe_with_meridians:  『embed / يكرر كلامك بمبيد』
:globe_with_meridians:  『server / معلومات عن السيرفر』
:globe_with_meridians:  『animal / يعطيك صور حيوانات』
:globe_with_meridians:  『image / يعرض صوره السيرفر』
:globe_with_meridians:  『avatar / يعرض صورتك او صوره شخص』
:globe_with_meridians:  『dt / يعرض الوقت في الامارات و مكه المكرمه و مصر و التاريخ』
**

        ***__Bot orders__***
**
:trackball:  『ping / يعرض لك سرعه اتصال البوت』
:trackball:  『uptime / يعرض لك صار للبوت كم شغال』
:trackball:  『support / سيرفر الدعم القني و المساعده』
:trackball:  『invite / اضافه البوت』
:trackball:  『bot / معلومات عن البوت』
**

        ***__Administrative Orders__***
**
:floppy_disk:  『kick / كيك』
:floppy_disk:  『ban / بان』
:floppy_disk:  『mute /ميوت』
:floppy_disk:  『unmute /فك الميوت』
:floppy_disk:  『mutechannel /قفل الشات』
:floppy_disk:  『unmutechannel /فتح الشات』
:floppy_disk:  『delet / مسح روم』
:floppy_disk:  『color 50 /انشاء 50 لون』
:floppy_disk:  『color 100/انشاء 100 لون』
:floppy_disk:  『color 140/انشاء 140 لوم』
:floppy_disk:  『ct /انشاء روم كتابي』
:floppy_disk:  『cv /انشاء روم صوتي』
:floppy_disk:  『bc /برودكاست』
**

        ***__Special orders __***
** 
:space_invader:  『colors / لي عرض قائمه الوان السيرفر』
:space_invader:  『color / لي تغير لونك』
**

        ***__Games orders__***
 **       
:video_game:  『لعبه صراحه / صراحه』
:video_game:  『لعبه مريم / مريم』
...
**
        ***__Minecraft__*** [New]
***
:soccer:  f!imn تجيب لك صورة نوب في ماين كرافت
:soccer:  f!mq عدة اسالة عن ماين كرافت

   
**
Server Support Link : https://discord.gg/Hf9TW4p_

Invite Bot Link : https://discordapp.com/api/oauth2/authorize?client_id=447792246494986250&permissions=2146958583&scope=bot
**
 ...
 **
 ...
 Bot Invite Link : https://discordapp.com/api/oauth2/authorize?client_id=447792246494986250&permissions=2146958583&scope=bot
...
if(!message.channel.guild) return;
var prefix = 'f!' 
if (message.content.startsWith(prefix + "imn")) {
    message.channel.sendMessage(`https://cdn.discordapp.com/attachments/448282261889220649/449616881683267594/download.jpg`);
    }
});
...
if (message.content.startsWith(prefix + "invite")) {
    message.channel.sendMessage(`https://discordapp.com/oauth2/authorize?client_id=447792246494986250&permissions=2146958583&scope=bot`);
    }
});
...
if (message.content.startsWith(prefix + "mq")) {
    message.channel.sendMessage(`من هو صاع ماين كرافت,ما اسم البلوكة التي تبقى مشتعلت غير النيت راك في عالم الثنين,ما هو الارتفاع المناسب للاماس,اين يتواجد الدهب,لمادا تحب ماين كرافت,ما هي البلوكة الاساسية في ماين كرافت`);
    }
});
...
if (message.content.startsWith(prefix + "support")) {
    message.channel.sendMessage(`https://discord.gg/Hf9TW4p`);
    }
});
...
if(!message.channel.guild) return;
var prefix = 'f!' 
if (message.content.startsWith(prefix + "السلام عليكم")) {
    message.channel.sendMessage(`و عليكم السلام و رحمة الله و بركاته`);
    }
});
...
if(!message.channel.guild) return;
var prefix = 'f!' 
if (message.content.startsWith(prefix + "حشيش")) {
    message.channel.sendMessage(`https://cdn.discordapp.com/attachments/449299620401643520/449628641228357632/tenor12.gif`);
    }
});
...
google({ query: input, disableConsole: true }).then(results => {
    return message.channel.send(`\n\n**العنوان**: ${results[0].title}\n***الرابط***: ${results[0].link}\الوصف: ${results[0].snippet}`);
}).catch(error => {
...
client.login('NDQ3NzkyMjQ2NDk0OTg2MjUw.DerbSA.lGEEQ17hALh3xxVGh9olHw-YAho')
